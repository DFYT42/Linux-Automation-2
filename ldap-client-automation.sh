...
nslcd nslcd/ldap-uris string ldap://nti310-final-nfs-client
...
ldap-auth-config ldap-auth-config/ldapns/ldap-server string ldap://nti310-final-nfs-client
...
sed -i 's,uri ldapi:///,uri ldap://nti310-final-nfs-client,g' /etc/ldap.conf
